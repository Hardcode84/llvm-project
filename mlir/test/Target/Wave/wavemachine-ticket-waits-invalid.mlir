// RUN: mlir-opt --waveamd-insert-ticket-waits -split-input-file -verify-diagnostics %s
...
func.func @missing_smem_base() {
  ...
  // expected-error @below {{waveamd-insert-ticket-waits expects scalar memory loads to carry a base register attribute}}
