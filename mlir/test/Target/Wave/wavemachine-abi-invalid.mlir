...
func.func @missing_memref_attr() attributes {wave.kernel} {
  // expected-error @below {{waveamd-abi-lowering expects wavemachine.arg to have a memref attribute}}
...
func.func @bad_kernel_arg_width() attributes {wave.kernel} {
  // expected-error @below {{waveamd-abi-lowering found argument register width inconsistent with memref attribute}}
